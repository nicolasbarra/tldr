...
TL;DR is a project that uses crowdsourcing as a means of human computation to generate effifienct and effecitve summaries of verbose texts that are preferred by users to summaries generated by machine learning algorithms.
